...
<script>
    function confirmRegister() {
    	  if (confirm("Are you sure you want to create the depot?")) {
...
<br /><br />
<form:form method="POST" commandName="depotForm" action="depotAdded.htm">
...
<table style="width: 100%; background-color: #eeeeee">
<tr>
<th colspan="3" align="left" style="background-color: #aaaaaa;" class="form">&nbsp;&nbsp;&nbsp;Depot Manager Details</th>
</tr>
<tr class="form">
