...
<span style="color: teal; font-size: 15pt;">Register and Start Selling Today<br /><br /></span>
Please have the following before you begin:<br /><br />
&#8226;&nbsp;Your business name, address, and contact information<br />
&#8226;&nbsp;A phone number where you can be reached during this registration process<br /><br />
Note: If you cannot comply with the registration requirements, please do not continue with this registration process.<br /><br />

<form:form method="POST" commandName="manufacturerForm" action="manuReg3.htm">
<%-- <form:errors path="*" cssClass="errorblock" element="div" /> --%>
<table style="width: 100%; background-color: #eeeeee">
<tr>
<th colspan="3" align="left" style="background-color: #aaaaaa;" class="form">&nbsp;&nbsp;&nbsp;Company Details</th>
</tr>
<tr class="form">
<td align="right" class="rowWidth">Business Name:</td>
<td>&nbsp;&nbsp;&nbsp;<form:input path="manufacturer.companyName" size="32" maxlength="64" value="" placeholder="Business Name" /></td>
<td><form:errors path="manufacturer.companyName" cssClass="error" /></td>
</tr>
<tr class="form">
...
<table style="width: 100%; background-color: #eeeeee">
<tr>
<th colspan="3" align="left" style="background-color: #aaaaaa;" class="form">&nbsp;&nbsp;&nbsp;Verification Document</th>
</tr>
</table>
<br /><br/><br/>
<!-- <input type="checkbox" name="terms" value="1"> &nbsp;I agree to the following: --> 
