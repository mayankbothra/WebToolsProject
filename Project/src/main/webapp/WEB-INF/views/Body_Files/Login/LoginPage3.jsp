...
$(document).ready(function() {
	$(".username").focus(function() {
		$(".user-ico").css("left","-48px");
	});
	$(".username").blur(function() {
		$(".user-ico").css("left","0px");
	});
	
	$(".password").focus(function() {
		$(".pass-ico").css("left","-48px");
	});
	$(".password").blur(function() {
		$(".pass-ico").css("left","0px");
	});
});
</script>
<div id="wrapper">
...
<div class="header">
<span style="color: red;font-size: 10pt;">Please Login to Purchase</span>
<h1>Login Form</h1>
</div>
<div class="content">
